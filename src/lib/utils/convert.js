import {lastOf} from './base';

export const workflow2reactflow = (workflow) => {
        ...
        edges: edges.map((edge) => ({
            ...
            data: {
                sourcePort: {
                    ...
                    portIndex: parseInt(
                        lastOf(edge.sourceHandle.split('#')),
                        10
                    ),
                    portCount: Object.keys(
                        nodeHandles[edge.source].sourceHandles
                    ).length,
                ...
                targetPort: {
                    ...
                    portIndex: parseInt(
                        lastOf(edge.targetHandle.split('#')),
                        10
                    ),
                    portCount: Object.keys(
                        nodeHandles[edge.target].targetHandles
                    ).length,
